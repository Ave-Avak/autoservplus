...
/**
 * Rapprochement commande / facture au niveau du controleur : chaque module repond
 * sur son domaine, l assemblage se fait ici. Le rendu reel du gabarit est couvert
 * par {@code HistoriqueCommandeTemplatesIT}.
 */
...
class HistoriqueCommandeControllerTest {
    ...
    @Test
    @DisplayName("l'identite vient du contexte de securite, pour les deux modules")
