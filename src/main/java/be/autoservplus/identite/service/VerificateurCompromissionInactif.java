 ...
 *
 * <p>Active des qu aucune autre implementation de {@link VerificateurCompromission}
 * n est presente — c est-a-dire en test d integration, et partout ou la verification
 * distante n est pas configuree. La liste embarquee reste seule en vigueur.</p>
 *
 ...
 */
@Service
@ConditionalOnMissingBean(ignored = VerificateurCompromissionInactif.class,
        value = VerificateurCompromission.class)
